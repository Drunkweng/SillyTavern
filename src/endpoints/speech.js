...
import { forwardFetchResponse, asyncHandler } from '../util.js';
...
pollinations.post('/voices', asyncHandler(async (req, res) => {
...
pollinations.post('/generate', asyncHandler(async (req, res) => {
