...
import { delay, getBasicAuthHeader, asyncHandler } from '../util.js';
...
router.post('/ping', asyncHandler(async (request, response) => {
...
router.post('/upscalers', asyncHandler(async (request, response) => {
...
router.post('/vaes', asyncHandler(async (request, response) => {
...
router.post('/samplers', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
...
router.post('/schedulers', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
...
router.post('/models', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
...
router.post('/get-model', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
    url.pathname = '/sdapi/v1/options';
...
router.post('/set-model', asyncHandler(async (request, response) => {
...
router.post('/sd-next/upscalers', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
    url.pathname = '/sdapi/v1/upscalers';
...
comfy.post('/ping', asyncHandler(async (request, response) => {
    try {
        const url = new URL(urlJoin(request.body.url, '/system_stats'));

        const result = await fetch(url);
        if (!result.ok) {
            console.warn(`ComfyUI connection failed to ${url.origin}. Please ensure ComfyUI is running on the specified URL.`);
            return response.status(503).send({ error: 'ComfyUI service unavailable', message: 'Please ensure ComfyUI is running on the specified URL.' });
        }
...
comfy.post('/samplers', asyncHandler(async (request, response) => {
    try {
...
comfy.post('/models', asyncHandler(async (request, response) => {
    try {
        const url = new URL(urlJoin(request.body.url, '/object_info'));
...
comfy.post('/schedulers', asyncHandler(async (request, response) => {
    try {
        const url = new URL(urlJoin(request.body.url, '/object_info'));
...
comfy.post('/vaes', asyncHandler(async (request, response) => {
    try {
        const url = new URL(urlJoin(request.body.url, '/object_info'));
...
comfy.post('/workflows', asyncHandler(async (request, response) => {
    const data = await getComfyWorkflows(request.user.directories);
    return response.send(data);
}));

comfy.post('/workflow', asyncHandler(async (request, response) => {
...
comfy.post('/save-workflow', asyncHandler(async (request, response) => {
...
comfy.post('/delete-workflow', asyncHandler(async (request, response) => {
    const filePath = path.join(request.user.directories.comfyWorkflows, sanitize(String(request.body.file_name)));
    try {
        await fs.access(filePath);
...
comfy.post('/generate', asyncHandler(async (request, response) => {
    try {
        let item;
...
together.post('/models', asyncHandler(async (request, response) => {
...
together.post('/generate', asyncHandler(async (request, response) => {
    const key = await readSecret(request.user.directories, SECRET_KEYS.TOGETHERAI);
...
drawthings.post('/ping', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
    url.pathname = '/';
...
drawthings.post('/get-model', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
    url.pathname = '/';
...
drawthings.post('/get-upscaler', asyncHandler(async (request, response) => {
    const url = new URL(request.body.url);
    url.pathname = '/';
...
drawthings.post('/generate', asyncHandler(async (request, response) => {
...
pollinations.post('/models', asyncHandler(async (_request, response) => {
...
pollinations.post('/generate', asyncHandler(async (request, response) => {
...
stability.post('/generate', asyncHandler(async (request, response) => {
...
huggingface.post('/generate', asyncHandler(async (request, response) => {
...
nanogpt.post('/models', asyncHandler(async (request, response) => {
...
nanogpt.post('/generate', asyncHandler(async (request, response) => {
    const key = await readSecret(request.user.directories, SECRET_KEYS.NANOGPT);
...
bfl.post('/generate', asyncHandler(async (request, response) => {
...
falai.post('/models', asyncHandler(async (_request, response) => {
...
falai.post('/generate', asyncHandler(async (request, response) => {
...
xai.post('/generate', asyncHandler(async (request, response) => {
...
aimlapi.post('/models', asyncHandler(async (request, response) => {
...
aimlapi.post('/generate-image', asyncHandler(async (req, res) => {
