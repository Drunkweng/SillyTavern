...
import { getConfigValue, uuidv4, asyncHandler } from '../util.js';
...
router.post('/libre', asyncHandler(async (request, response) => {
...
router.post('/google', asyncHandler(async (request, response) => {
    const text = request.body.text;
    const lang = request.body.lang;
...
router.post('/yandex', asyncHandler(async (request, response) => {
...
router.post('/lingva', asyncHandler(async (request, response) => {
...
router.post('/deepl', asyncHandler(async (request, response) => {
...
router.post('/onering', asyncHandler(async (request, response) => {
...
router.post('/deeplx', asyncHandler(async (request, response) => {
...
router.post('/bing', asyncHandler(async (request, response) => {
    const text = request.body.text;
    let lang = request.body.lang;
